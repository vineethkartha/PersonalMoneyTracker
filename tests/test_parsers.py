...
class TestParsers(unittest.TestCase):
    ...
    def test_upi_parser(self):
        ...
        self.assertEqual(parsed['Category'], 'Food and others')
        self.assertEqual(parsed['Subcategory'], 'Groceries and household items')
    ...
    def test_credit_card_parser(self):
        ...
        parsed = parser.parse(message)
        self.assertEqual(parsed['Date'], '09/06/2025')
        self.assertEqual(parsed['Account'], 'SBI credit card')
        self.assertEqual(parsed['Category'], 'Food and others')
        self.assertEqual(parsed['Subcategory'], 'Eating out')
